      ...
      <div class="modal-content">
        <form @submit.prevent="mode == 'create' ? store() : update()" enctype="multipart/form-data">
          <div class="modal-header">
            <h5 class="modal-title"> <i :class="[icon]"></i> {{ modalTitle }} </h5>
          ...
          <div class="modal-footer mb-1">
            ...
            >
              <span v-if="isLoading"> <i class="fas fa-circle-notch fa-spin"></i> Mohon Tunggu..</span>
              <span v-else>
            ...
            >
              <span v-if="isLoading"> <i class="fas fa-circle-notch fa-spin"></i> Mohon Tunggu..</span>
              <span v-else><i class="bi bi-save"></i> Update</span>
            </button>
